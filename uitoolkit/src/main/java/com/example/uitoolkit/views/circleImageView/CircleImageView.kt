package com.example.uitoolkit.views.circleImageView
...
class CircleImageView : AppCompatImageView {
    ...
    override fun setImageAlpha(alpha: Int) {
        var imageAlpha = alpha
        imageAlpha = imageAlpha and 0xFF
        if (imageAlpha == mImageAlpha) {
            return
        }
